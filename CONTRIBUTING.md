# Contributing to Cache Manager

Thank you for considering contributing to **Cache Manager**! 🙌
...
Start by [forking the repository](https://github.com/beyond-the-cloud-dev/cache-manager/fork) to your own GitHub account.

### 2. Clone Your Fork

```bash
git clone https://github.com/YOUR_USERNAME/cache-manager.git
cd cache-manager
```
...
- For Apex classes: follow existing patterns in CacheManager.cls
...
```bash
git add .
git commit -m "feat: add new cache partition support"
...
- New cache features
- Additional cache partition support
- CI/CD improvements
...
- Check existing [Issues](https://github.com/beyond-the-cloud-dev/cache-manager/issues)
- Create a new issue for questions

Thank you for helping make Cache Manager better! 🚀
